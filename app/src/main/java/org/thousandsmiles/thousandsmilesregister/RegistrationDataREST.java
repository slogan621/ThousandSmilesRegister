 ...
 */
public class RegistrationDataREST extends RESTful {
    ...
    private class ResponseListener implements Response.Listener<JSONObject> {
        ...
        public void onResponse(JSONObject response) {
            ...
            synchronized (m_lock) {
                ...
                setStatus(200);
                try {
                    data.setPaidDinner(response.getBoolean("dinner"));
                    data.setPaidHotel(response.getBoolean("hotel"));
                    data.setPaidFee(response.getBoolean("fee"));
                    data.setPaidBus(response.getBoolean("bus"));
    ...
    public RegistrationDataREST(Context context) {
        m_context = context;
    }

    public Object getRegistrationData(int regid) {
        ...
        String url = String.format("%s:%s/registrations/%d/", getDBAPIHost(), getDBAPIPort(), regid);
